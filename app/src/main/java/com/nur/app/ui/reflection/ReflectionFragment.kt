package com.nur.app.ui.reflection
...
class ReflectionFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        b.tvFeedLabel.text = "Nightly Reflections"
        b.tvFeedSubtitle.text = "End your day with peace and purpose"
        adapter = FeedAdapter(
        ...
        viewLifecycleOwner.lifecycleScope.launch {
            vm.reflections.collect { posts -> _b ?: return@collect; adapter.submitList(posts); if (posts.isEmpty()) b.tvEmpty.show() else b.tvEmpty.hide() }
        }
        viewLifecycleOwner.lifecycleScope.launch {
